...
type RouteId = '/docs/configuring/[...rest]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/docs/configuring/[...rest]/+page.server.js').load>>>>>>;
