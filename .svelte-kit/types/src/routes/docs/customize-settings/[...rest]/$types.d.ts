...
type RouteId = '/docs/customize-settings/[...rest]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/docs/customize-settings/[...rest]/+page.server.js').load>>>>>>;
